...
from serl_launcher.wrappers.serl_obs_wrappers import SERLObsWrapper #originally onlz SERLObsWrapper
...
if __name__ == "__main__":
    ...
    fw_classifier_func = load_classifier_func(
        ...
        checkpoint_path="/home/shilber/delete/fw_classifier_ckpt",
    )
    rng, key = jax.random.split(rng)
    bw_classifier_func = load_classifier_func(
        ...
        sample=env.front_observation_space.sample(),
        image_keys=image_keys,
        checkpoint_path="/home/shilber/delete/bw_classifier_ckpt",
    )
